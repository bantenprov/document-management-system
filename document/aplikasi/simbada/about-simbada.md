...
[![cover](/document/aplikasi/simbada/images/about-simbada/20171110_cover-simbada.jpeg)](/document/aplikasi/simbada/images/about-simbada/20171110_cover-simbada.jpeg)
...
[![Ilustrasi Alur Prototyping](/document/aplikasi/simbada/images/about-simbada/alur-prototype/alur-prototype.png)](/document/aplikasi/simbada/images/about-simbada/alur-prototype/alur-prototype.png)
...
[![Use Case Diagram](/document/aplikasi/simbada/images/about-simbada/use-case/20171023_use-case-diagram-aset.png)](/document/aplikasi/simbada/images/about-simbada/use-case/20171023_use-case-diagram-aset.png)

#### 3.3.2 *Sequence Diagram*
[![Sequence Diagram](/document/aplikasi/simbada/images/about-simbada/sequence-diagram/sequence-diagram-aset.png)](/document/aplikasi/simbada/images/about-simbada/sequence-diagram/sequence-diagram-aset.png)

#### 3.3.3 *Activity Diagram*
* *Activity Diagram Login Admin*
[![Activity Diagram Login Admin](/document/aplikasi/simbada/images/about-simbada/activity-diagram/20171014_activity-diagram-login-admin.png)](/document/aplikasi/simbada/images/about-simbada/activity-diagram/20171014_activity-diagram-login-admin.png)

* *Activity Diagram Input Data Aset*
[![Activity Diagram Input Data Aset](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-input-aset.png)](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-input-aset.png)

* *Activity Diagram Lihat Data Aset*
[![Activity Diagram Lihat Data Aset](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-lihat-laporan-aset.png)](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-lihat-laporan-aset.png)

* *Activity Diagram Edit Data Aset*
[![Activity Diagram Edit Data Aset](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-edit-aset.png)](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-edit-aset.png)

* *Activity Diagram Hapus Data Aset*
[![Activity Diagram Hapus Data Aset](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-hapus-aset.png)](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-hapus-aset.png)

* *Activity Diagram Cetak Data Aset*
[![Activity Diagram Cetak Data Aset](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-cetak-laporan-aset.png)](/document/aplikasi/simbada/images/about-simbada/activity-diagram/activity-diagram-cetak-laporan-aset.png)

#### 3.3.4 *State Chart Diagram*
* *State Chart Diagram Login Admin*
[![State Chart Diagram Login Admin](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-login-admin.png)](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-login-admin.png)

* *State Chart Diagram Input Aset*
[![State Chart Diagram Input Aset](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-input-aset.png)](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-input-aset.png)

* *State Chart Diagram Lihat Aset*
[![State Chart Diagram Lihat Aset](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-lihat-aset.png)](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-lihat-aset.png)

* *State Chart Diagram Edit Aset*
[![State Chart Diagram Edit Aset](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-edit-aset.png)](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-edit-aset.png)

* *State Chart Diagram Hapus Aset*
[![State Chart Diagram Hapus Aset](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-hapus-aset.png)](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/20171023_state-chart-diagram-hapus-aset.png)

* *State Chart Diagram Cetak Aset*
[![State Chart Diagram Cetak Aset](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-export-aset.png)](/document/aplikasi/simbada/images/about-simbada/state-chart-diagram/state-chart-diagram-export-aset.png)

#### 3.3.5 Deployment Diagram
[![Deployment Diagram](/document/aplikasi/simbada/images/about-simbada/dep-tec-class/deployment-diagram.png)](/document/aplikasi/simbada/images/about-simbada/dep-tec-class/deployment-diagram.png)

#### 3.3.6 Technology Stack Diagram
[![Technology Stack Diagram](/document/aplikasi/simbada/images/about-simbada/dep-tec-class/technology-stack-diagram.png)](/document/aplikasi/simbada/images/about-simbada/dep-tec-class/20171013_technology-stack-diagram.png)
...
[![Layout Tampilan Login](/document/aplikasi/simbada/images/about-simbada/design-tampilan/layout-login.png)](/document/aplikasi/simbada/images/about-simbada/design-tampilan/layout-login.png)

#### 3.5.2 Layout Tampilan Dashboard
[![Layout Tampilan Dashboard](/document/aplikasi/simbada/images/about-simbada/design-tampilan/layout-dashboard.png)](/document/aplikasi/simbada/images/about-simbada/design-tampilan/layout-dashboard.png)

#### 3.5.3 Layout Tampilan List Aset
[![Layout Tampilan List Aset](/document/aplikasi/simbada/images/about-simbada/design-tampilan/layout-list-laporan.png)](/document/aplikasi/simbada/images/about-simbada/design-tampilan/layout-list-laporan.png)

#### 3.5.3 Layout Tampilan Input Aset
[![Layout Tampilan List Aset](/document/aplikasi/simbada/images/about-simbada/design-tampilan/layout-input-aset.png)](/document/aplikasi/simbada/images/about-simbada/design-tampilan/layout-input-aset)
