...
Untuk memulai akses terhadap aplikasi **Dashboard Pimpinan**. Buka web browser (IE, Mozila Firefox atau yang lainnya) dengan menulis alamat url http://dashboard-01.dev.bantenprov.go.id kemudian tekan **Enter** pada tombol keyboard atau klik tombol **Go** pada browser. Akan muncul tampilan halaman login aplikasi dashboard seperti gambar dibawah ini.

### 1. Tampilan Login
[![tampilan-login-admin](/document/aplikasi/dashboard-pimpinan/images/implementasi/tampilan-login-admin.png)](/document/aplikasi/dashboard-pimpinan/images/implementasi/tampilan-login-admin.png)
...
##### 5.1.1 Prosentase dan Grafik Jumlah Pegawai
...
##### 5.1.2 Prosentase dan Grafik Kenaikan Pangkat Pegawai Otomatis
...
##### 5.1.3 Prosentase dan Grafik Pensiun Pegawai
...
##### 5.1.4 Prosentase dan Grafik Usia ASN
...
##### 5.1.5 Prosentase dan Grafik Jumlah Pegawai Esselon
...
##### 5.1.6 Prosentase dan Grafik Pangkat Pegawai
...
#### 5.2  Dashboard Kependudukan

##### 5.2.1 Prosentase dan Grafik Jumlah Penduduk
...
#### 5.3 Dashboard Kesehatan

##### 5.3.1 Prosentase dan Grafik Jumlah Tim Medis
...
#### 5.4 Dashboard Kependidikan

##### 5.4.1 Prosentase dan Grafik Jumlah Tenaga Pendidik
...
#### 5.5 Dashboard Epormas

#### 5.5.1 Prosentase dan Grafik Jumlah Laporan
...
##### 6.1.1 Form Tabel Tambah Jumlah Pegawai
...
##### 6.2.1 Form Tabel Tambah Pegawai KPO (Kenaikan Pangkat Otomatis)
...
##### 6.3.1 Form Tabel Tambah Jumlah Pegawai Esselon
...
#### 6.4 List Usia ASN (Aparatur Sipil Negara)
...
##### 6.4.1 Form Tabel Tambah Usia ASN (Aparatur Sipil Negara)
...
#### 6.5 List Pegawai Yang Akan Pensiun
...
##### 6.5.1 Form Tabel Tambah Jumlah Pegawai Yang Akan Pensiun
...
##### 7.1.1 Form Tabel Tambah Penduduk
...
##### 8.1.1 Form Tabel Tambah Tim Medis
...
##### 9.1.1 Form Tabel Tambah Pendidik
...
##### 10.1.1 Form Tabel Tambah Laporan
...
##### 11.1.1. Form Tabel Add New User
...
##### 11.2.1.  Form Tabel Add Role User
...
##### 11.3.1 Form Tabel Add Permissions
...
#### 11.4  Profile User
[![user-profile-admin-edit](/document/aplikasi/dashboard-pimpinan/images/implementasi/user-profile-admin-edit.jpeg)](/document/aplikasi/dashboard-pimpinan/images/implementasi/user-profile-admin-edit.jpeg)
